...
def train_target(args):
    ...
    for p, q in netC.named_parameters() and netC1.named_parameters() and netC2.named_parameters():
    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 and args.cls_par > 0:
            ...
            label_map1 = {}
            rev_label_map1 = {}
            mem_label1 = obtain_label(dset_loaders['test1'], netF, netB, netC1, args)
            ...
            label_map2 = {}
            rev_label_map2 = {}
            mem_label2 = obtain_label(dset_loaders['test2'], netF, netB, netC2, args)
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            netC1.eval()
            netC2.eval()
            acc1, _ = cal_acc(dset_loaders['test'], netF, netB, netC, label_list, label_map)
            ...
            acc2, _ = cal_acc(dset_loaders['test1'], netF, netB, netC1, label_list1, label_map1)
            ...
            log_str3 = 'Task: {}, Iter:{}/{}; Accuracy = {:.2f}% / {:.2f}% / {:.2f}%'.format(args.name3, iter_num,
                                                                                            max_iter, acc_os2, acc_os1,
                                                                                            acc_unknown)

            # acc3, _ = cal_acc(dset_loaders['test2'], netF, netB, netC2, label_list1, label_map2)
