...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 and args.cls_par > 0:
            ...
            label_map2 = {}
            rev_label_map2 = {}
            mem_label2 = obtain_label1(dset_loaders['test2'], netF, netB, netC2, netC_ex, args)
        ...
        if args.cls_par > 0:
            ...
            maxdummy, _ = torch.max(outputs_test_ex2.clone(), dim=1)
            maxdummy = maxdummy.view(-1, 1)
            dummpyoutputs_1 = torch.cat((outputs_test2.clone(), maxdummy), dim=1)
            # print(dummpyoutputs_1.size())
            for i in range(len(dummpyoutputs_1)):
                nowlabel = pred1[i]
                dummpyoutputs_1[i][nowlabel] = -1e9
            dummytargets_1 = torch.ones_like(pred1) * args.class_num
            ...
            classifier_loss += nn.CrossEntropyLoss()(dummpyoutputs, dummytargets) * 0.1
...
if __name__ == "__main__":
    ...
    if args.dset == 'office-home':
        ...
        args.tar_classes1 = [i for i in range(25)]
