...
def train_source(args):
    ...
    torch.save(best_netF, osp.join(args.output_dir_src, "source_F3.pt"))
    torch.save(best_netB, osp.join(args.output_dir_src, "source_B3.pt"))
    torch.save(best_netC, osp.join(args.output_dir_src, "source_C3.pt"))
...
def test_target(args):
    ...
    args.modelpath = args.output_dir_src + '/source_F3.pt'
    netF.load_state_dict(torch.load(args.modelpath))
    args.modelpath = args.output_dir_src + '/source_B3.pt'
    netB.load_state_dict(torch.load(args.modelpath))
    args.modelpath = args.output_dir_src + '/source_C3.pt'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--da', type=str, default='sda', choices=['uda', 'pda', 'oda'])
